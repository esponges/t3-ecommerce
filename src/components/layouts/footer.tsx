        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          "
            >
              ...
              <span className='uppercase'>{env.NEXT_PUBLIC_STORE_NAME}</span>
            </h6>
            <p>Your store slogan here.</p>
          </div>
          <div className="">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Products</h6>
            {/* todo: map top categories */}
            <Link href={`${PageRoutes.List}`}>
              <p className="mb-4 cursor-pointer">Category 1</p>
            </Link>
            <Link href={`${PageRoutes.List}`}>
              <p className="mb-4 cursor-pointer">Category 2</p>
            </Link>
            <Link href={`${PageRoutes.List}`}>
              <p className="mb-4 cursor-pointer">Category 3</p>
            </Link>
            <Link href={`${PageRoutes.List}`}>
              <p>Category 4</p>
            </Link>
          ...
          <div className="">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">About Us</h6>
            <Link href={`${PageRoutes.Privacy}`}>
              <p className="mb-4 cursor-pointer">Privacy</p>
            </Link>
            <Link href={`${PageRoutes.DataPolicy}`}>
              <p className="mb-4 cursor-pointer">Data Policy</p>
            </Link>
